...
// --- CONFIGURATION ---
private const val BOT_TOKEN = "YOUR_BOT_TOKEN_HERE" // TODO: Replace with your bot's token
private const val MINECRAFT_SERVER_IP = "play.example.net" // TODO: Replace with your Minecraft server IP
private val TARGET_CHANNEL_ID = Snowflake("123456789012345678") // TODO: Replace with your channel ID
        ...
        kord.on<ReadyEvent> {
            ...
            while (true) {
                ...
                if (usePlayerCountStatus) {
                    ...
                    val memberCount = channel.guild.getMemberCount() ?: "N/A"
                    kord.editPresence {
                ...
                if (serverStatus != null) {
                    ...
                    val messageContent = "Status updated: ${java.time.Instant.now()}"
                    ...
                    if (statusMessage == null) {
                        ...
                        statusMessage = channel.createMessage {
                            ...
                            embed {
                                ...
                                color = if (serverStatus.online) Color(0x4CAF50) else Color(0xF44336)
                            }
                        }
                    } else {
                        ...
                        statusMessage?.edit {
                            ...
                            files = mutableListOf(dev.kord.rest.NamedFile(fileName, ByteReadPacket(imageBytes)))
                            embed {
                                this.image = "attachment://$fileName"
                                color = if (serverStatus.online) Color(0x4CAF50) else Color(0xF44336)
                            }
